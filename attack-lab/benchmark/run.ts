...
const thresholds = { recall: 0.90, fpr: 0.05, p95Ms: 50, blockRate: 0.80, scenarioPassRate: 1, fixturePassRate: 1, fixtureCoverageRate: 1, koreanServiceTokenRecall: 0.90, koreanServiceTokenFpr: 0.05, highEntropyRecall: 0.90, highEntropyFpr: 0.05, koreanInjectionRecall: 0.90, koreanInjectionFpr: 0.05 };
const metrics = {
  recall,
  fpr,
  precision,
...
const report = { generatedAt: new Date().toISOString(), metrics, thresholds, perTypeRecall, koreanServiceTokens, highEntropySecrets, koreanInjection, validationImpact, scenarios: scenarioResults, fixtures: fixtureResults, fixtureCoverage, passed };
