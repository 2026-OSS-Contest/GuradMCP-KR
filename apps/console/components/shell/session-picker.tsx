...
export function SessionPicker() {
  ...
  // Dismiss on outside click or Escape, the same way the policy chip's popover does.
  useEffect(() => {
    if (!open) return;
    ...
    <div ref={ref} className="relative flex-none">
      ...
      {open && (
        <div
          ...
          className="absolute top-full right-0 z-30 mt-2 w-72 max-w-[calc(100vw-2rem)] rounded-lg bg-grayscale-900 p-2 shadow-xl shadow-black/50 outline-1 -outline-offset-1 outline-grayscale-700"
        >
          {failed ? (
